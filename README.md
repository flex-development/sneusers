...
| `CACHE_TTL`            | `5`                          | Amount of time a response is cached before it is deleted (in seconds)                  |
...
| `DB_TIMEZONE`          | `'-05:00'`                   | Timezone used when converting a date from the database into a JavaScript `Date` object |
...
| `JWT_EXP_ACCESS`       | `900`                        | Access token expiration time (in seconds)                                              |
| `JWT_EXP_REFRESH`      | `86400`                      | Refresh token expiration time (in seconds)                                             |
| `JWT_EXP_VERIFY`       | `86400`                      | Verification token expiration time (in seconds)                                        |
...
| `NODE_ENV`             | `NodeEnv.DEV`                | Node environment                                                                       |
