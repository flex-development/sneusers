...
| `GOOGLE_AUTHORIZATION_URL`   | `'https://accounts.google.com/o/oauth2/v2/auth'`  | GitHub OAuth authorization URL                                                             |
| `GOOGLE_CLIENT_ID`           | -                                                 | GitHGoogleub OAuth client id                                                               |
| `GOOGLE_CLIENT_SECRET`       | -                                                 | Google OAuth client id                                                                     |
| `GOOGLE_SCOPES`              | -                                                 | List of Google OAuth scopes                                                                |
| `GOOGLE_SCOPES_SEPARATOR`    | `' '`                                             | `$GOOGLE_SCOPES` list separator                                                            |
| `GOOGLE_TOKEN_URL`           | `'https://www.googleapis.com/oauth2/v4/token'`    | Google OAuth access token URL                                                              |
| `GOOGLE_USER_PROFILE_URL`    | `'https://www.googleapis.com/oauth2/v3/userinfo'` | Google OAuth user profile URL                                                              |
...
| `FORCE_COLOR`               | Detect whether the terminal [supports color](https://github.com/chalk/supports-color)               |
